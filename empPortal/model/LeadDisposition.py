...
class LeadDisposition(models.Model):
    ...
    created_by = models.ForeignKey(User, related_name='lead_dispositions_created_by', on_delete=models.SET_NULL, null=True, blank=True)
    updated_by = models.ForeignKey(User, related_name='lead_dispositions_updated_by', on_delete=models.SET_NULL, null=True, blank=True)
